...
class Settings:
    app_name: str = os.getenv("APP_NAME", "Duka API")
    base_url: str = os.getenv("BASE_URL", "http://127.0.0.1:8000")
    database_url: str = os.getenv(
        "DATABASE_URL",
        "postgresql://postgres:Mdan10532@localhost:5432/flask_shop",
    )
    ...
    def mpesa_callback_url(self) -> str:
        return f"{self.base_url.rstrip('/')}/stk_call_back"
